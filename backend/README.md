...
## Project Structure
    ...
    ├── figma_test_edulabzz_34958  # Django project configurations
...
1. Clone this repo and `cd figma_test_edulabzz_34958`
...
2. Clone this repo and `cd figma_test_edulabzz_34958`
